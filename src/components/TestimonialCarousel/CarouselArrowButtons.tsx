...
export const PrevButton: React.FC<ArrowButtonProps> = (props) => {
  ...
  return (
    <button
      type="button"
      className={cn(
        'relative flex size-14 items-center justify-center rounded-full cursor-pointer text-primary-500 hover:text-primary-600 dark:text-accent-400 dark:hover:text-accent-300 transition-all duration-200 ease-in-out transform hover:scale-125',
